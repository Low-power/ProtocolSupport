...
public class InitialPacketDecoder extends SimpleChannelInboundHandler<ByteBuf> {
	...
	private static final int ping152delay = Utils.getJavaPropertyValue("ping152delay", Integer.valueOf(100));
	private static final int pingLegacyDelay = Utils.getJavaPropertyValue("pinglegacydelay", Integer.valueOf(200));
	...
	static {
		...
		pipelineBuilders.put(ProtocolVersion.MINECRAFT_2_0, builder15);
